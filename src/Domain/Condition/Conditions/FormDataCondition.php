...
final class FormDataCondition extends AbstractArrayCollection
{
    ...
    public function setFieldCondition(FormFieldName $parameter, FormFieldCondition $condition)
    {
        parent::set($parameter->asString(), $condition);
    }
    ...
    {
        return new FormFieldConditionIterator($this->array);
    }
}
